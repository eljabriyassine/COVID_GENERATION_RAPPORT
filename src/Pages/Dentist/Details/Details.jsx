            ...
            <Row>
              <Col md={7} lg={8}>
                <div className="single-dentist-details">
                  ...
                  <p>
                    During the COVID-19 pandemic, our clinic is committed to
                    maintaining the highest standards of safety and hygiene. We
                    follow strict protocols recommended by health authorities to
                    ensure the well-being of our patients and staff. Your health
              ...
              <Col lg={6}>
                <div className="expertDentist-txt mt-5 mt-lg-0">
                  ...
                  <p>
                    ...
                    has embraced Cosmetic Dentistry and has redesigned the
                    smiles for thousands of patients.
                  </p>
                  <p>
                    Dr. Harrie believes in providing his patients with more than
                    just world-class dental care. He also helps patients
                    recognize the vital connection between dental health and
                    overall body health. As a graduate of the University of
                    California’s School of Dentistry, Dr. Harrie is a leader in
                    the movement to bring environmental sanity and well-being
                    into the dental world for the future.
                  </p>
                </div>
              </Col>
            </Row>
